...
def cumulative_object_counting_x_axis(input_video, detection_graph, category_index, is_color_recognition_enabled, targeted_object, fps, width, height, roi, deviation,logFile, roiAreas):
        total_passed_vehicle = 0
       
        #initialize .csv
        with open(logFile, 'w', newline='') as f:
                writer = csv.writer(f)  
                columnName = ['Timestamp', 'Object_Type', 'Object_Color', 'Movement_Direction', 'Object_Speed(km/h)']  
            ...
            # for all the frames that are extracted from input video
                while(cap.isOpened()):
                    ...
                    for area in roiAreas:
                        ...
                        cv2.rectangle(input_frame, (0, 100), (100, 200), (255,0,0), -1)
                        cv2.rectangle(input_frame, (area[0], area[1]), (area[2],area[3] ), (255,0,0), -1)
                        # apply the overlay
                        alpha=0.5
                    ...
                    if(csv_line != "not_available"):
                            with open(logFile, 'a') as f:
                                    ...
                                    logRow.insert(0,datetime.datetime.now().strftime("%c"))   
                                    logRow.insert(2,'')                                           
